...
class Hangman:
    ...
    def __update_guess(self, guess):
        '''
        This method is used to update the word_guessed list with the guess in the correct place(s) and decrement the counter of unique letteres remaining.
    ...
    def __check_guess(self, guess):
        '''
        This method is used to check whether a given guess is in the randomly chosen word. The result will be output to the screen.
    ...
    def ask_for_input(self):
        '''
        This method asks for input from the user a validates that it is a single alphabetical character that has not been guessed previously.
        '''
